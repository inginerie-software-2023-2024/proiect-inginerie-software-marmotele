import {
    ...
    Stack,
    Heading,
    Input, SliderTrack, SliderFilledTrack, SliderThumb, Text, useColorModeValue
...
const SOMATIC_TYPES: OptionsOrGroups<string, any> | undefined = [
    {
        value: "0", label: "Ectomorf",
    },
    {
        value: "1", label: "Mezomorf"
    },
    {
        value: "2", label: "Endomorf"
    }
]
        ...
        <Container sx={{display: 'flex', p: 7, flexDirection: 'column'}}>
            ...
            <Stack pt={6} flexDirection="column" spacing={3}>
                <FormControl color="black" zIndex={13}>
                    ...
                    <Select value={gender} onChange={(e) => setGender(e as string)} options={GENDER}/>
                </FormControl>
                ...
                <FormControl color="black" zIndex={10}>
                    ...
                    <Select
                        ...
                        onChange={(e) =>
                            setObjective({...objective, type: e as string})}
                        options={OBJECTIVE}
                    />
                </FormControl>
                {!isAuthenticated &&
                ...
                {objective.type != '1' && (
                    <FormControl>
                        ...
                        <Text>On a scale of 1 to 10, how fast do you want to achieve this goal?</Text>
                        <Slider
                            zIndex={2}
                            defaultValue={0}
                            step={1}
                ...
                <FormControl>
                    ...
                    <Text>On a scale of 1 to 10, how active are you on a day to day basis?</Text>
                    <Slider
                        zIndex={2}
                        defaultValue={0}
                        step={1}
            ...
            <Button colorScheme={"lightPallette.primary"} onClick={calculateResult}>
                Calculate
            </Button>
        </Container>
    );
