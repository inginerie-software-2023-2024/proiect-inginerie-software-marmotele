...
import {
    ...
    AlertDialogHeader,
    AlertDialogBody,
    AlertDialogFooter, Tr, Td, Tbody, Thead,
...
const UsersPage = () => {
    ...
    return (
        <>
                                ...
                                <Td>
                                    <Tooltip title="Make Admin">
                                        <IconButton
                                            ...
                                            onClick={() => handleMakeAdminClick(user.userId.toString(10))}
                                        >
                                            <GrUserAdmin/>
                                        </IconButton>
                                    </Tooltip>
                                    <Tooltip title="Delete user">
                                        <IconButton
                                            ...
                                            onClick={() => handleDeleteClick(user.userId.toString(10))}
                                        >
                                            <DeleteIcon/>
                                        </IconButton>
                                    </Tooltip>
            ...
            <AlertDialog isOpen={deleteDialogOpen} onClose={handleDeleteDialogClose} leastDestructiveRef={cancelRef}>
                <AlertDialogOverlay>
                    <AlertDialogContent>
